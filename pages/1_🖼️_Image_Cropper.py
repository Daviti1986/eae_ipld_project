...
min_height = 0 
max_height = img.height    # TODO: Replace None with the maximum height of the image using np.shape() function

min_width = 0
max_width = img.width   # TODO: Replace None with the maximum width of the image using np.shape() function   
